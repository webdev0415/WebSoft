...
<body>
    ...
    <!------------------------------ CONTENT ------------------------------>
    <div id="suspended" class="content">
        <div class="card">
            <h1>Your idea has been successfully sent to our development team. Thank you for your contribution!</h1>
        </div>
    </div>
    ...
    <script src="js/suspended.js"></script>
</body>
