    ...
    <div id="reports" class="content">
        <div id="admin_header">
            <div class="row page_selector">
                <div class="col-4 select_tab um_selector">
                    <a href="admin.php">User Management</a>
                </div>
                <div class="col-4 select_tab ut_selector">
                    <a href="admin_upload.php">Upload Upcoming Tool</a>
                </div>
                <div class="col-4 select_tab br_selector">
                    <a href="reports.php">Bug report/Recommendations</a>
                </div>
            </div>
        </div>
