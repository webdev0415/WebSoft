...
<body>
    ...
    <?php include "components/admin_header.php"; ?>
        ...
        <div class="row page_selector">
                <div class="col-6 select_tab um_selector">
                    <a href="admin_reports.php">Bug reports</a>
                </div>
                <div class="col-6 select_tab ut_selector">
                    <a href="admin_recommendations.php">Future recommendations</a>
                </div>
            </div>
        </div>
