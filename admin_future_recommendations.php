...
<body>
    ...
    <!------------------------------ CONTENT ------------------------------>
    <div id="future_recommendations" class="content">
    <?php include "components/admin_header.php"; ?>
        <div id="reports_header">
        <div class="row page_selector">
                <div class="col-6 select_tab br_inner_selector">
                    <a href="admin_bug_reports.php">Bug reports</a>
                </div>
                <div class="col-6 select_tab fr_inner_selector">
                    <a href="admin_future_recommendations.php">Future recommendations</a>
                </div>
            </div>
        </div>
