...
function loadReports(){
    $.ajax({
        type: "post",
        url: "../backend/index.php?action=getBugReports",
        data: {
                            ...
                            <div id="collapse${index}" class="collapse" aria-labelledby="heading${index}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="report_image_container">
                                        <img src="../backend/uploads/bug_reports/${this.hash}.png" width="100%" height="100%">
                                    </div>
                                </div>
                            </div>
                        </div>`)
...
function deleteReport(){
    $(".closeReport").click(function(e){
        ...
        $.ajax({
            type: "post",
            url: "../backend/index.php?action=deleteBugReport",
            data: {
