<html>
        ...
        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#" onclick="document.getElementById('input_file').click();">Load from local Drive</a>
            <a class="dropdown-item" onclick="showPickerDialog()">Google Drive</a>
